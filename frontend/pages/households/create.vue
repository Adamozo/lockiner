...
<template>
  <div class="max-w-2xl mx-auto space-y-8">
    ...
    <!-- Info box -->
    <div
      class="p-4 bg-electric-green/10 border border-electric-green/30 rounded-lg"
    >
      <div class="flex">
        <UIcon
        ...
        <div class="text-sm text-pure-white/80">
          ...
          <p>
            As the creator, you'll automatically become the manager of this
            household. Managers can invite members, manage roles, and delete the
            household.
          </p>
        </div>
      </div>
